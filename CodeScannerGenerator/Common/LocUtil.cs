...
namespace CodeScannerGenerator.Common
{
    public static class LocUtil
    {
        ...
        /// <summary>
        /// Get translated string from global application resources, 
        /// to use in code behind
        /// </summary>
        /// <param name="key">ID of framework element</param>

        public static string TranslatedString(string key)
        {
            try
            {
        ...
        /// <summary>
        /// Get translated string from specified window's resources, 
        /// to use in code behind
        /// </summary>
        /// <param name="key">ID of framework element</param>

        public static string TranslatedString(string key, FrameworkElement window)
        {
            try
            {
